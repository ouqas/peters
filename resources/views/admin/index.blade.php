...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.html">Welcome Peter</a>
      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages">
          ...
          <ul class="sidenav-second-level collapse" id="collapseExamplePages">
            ...
            <li>
              <a href="ourQualities.html">OURQUALITIES </a>
            </li>
            <li>
              <a href="dayTrip.html">DAY TRIPS </a>
            </li>
            <li>
              <a href="reservation.html">RESERVATION </a>
            </li>
            <li>
              <a href="tripAndTours.html">TRIPS AND TOURS </a>
            </li>
            <li>
        ...
        <div class="col-md-3">
            <div class="d-flex border">
                ...
                <div class="flex-grow-1 bg-white p-4">
                    ...
                    <h3 class="font-weight-bold mb-0">155</h3>
                </div>
            </div>
        </div>
        <div class="col-md-3">
